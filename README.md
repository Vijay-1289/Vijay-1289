...
<p align="center">
  <!-- Typing Effect (JP → EN) -->
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=28&pause=1200&color=F75C7E&center=true&vCenter=true&width=950&height=60&lines=🔥+AI+Enthusiast;🤖+Machine+Learning+Explorer;🐍+Python+Developer;📊+Data+Science+Lover;⚛️+Quantum+Curious" alt="Typing SVG" />
</p>
...
- Built an **AI-powered health assistant** that predicts diseases from symptoms  
- Demonstrated **end-to-end ML pipeline**: preprocessing → model training → UI  
- Showcases applied **Data Science in Healthcare**  
🔗 [GitHub Repo](https://github.com/Vijay-1289/AI-Health)

---

### ⚛️ Quantum Warrior | Qiskit + Python  
- Designed an **interactive quantum-themed game** using Qiskit  
- Implemented **quantum gates & measurements** in a gamified environment  
- Creative project bridging **Quantum Mechanics + Game Dev**  
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Vijay-1289/Vijay-1289/main/output/dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Vijay-1289/Vijay-1289/main/output/light.svg" />
